    ...
    return (
        <section className="py-12">
            ...
            <div className="grid md:grid-cols-2 gap-6 px-4">
                ...
                <motion.div
                    whileHover="hover"
                    className="relative h-[250px] w-full cursor-pointer rounded-3xl overflow-hidden shadow-2xl group"
                >
                    {/* Background & Content */}
                    <div className="absolute inset-0 bg-gradient-to-br from-[#1a1f2e] to-[#0f172a] border border-white/10 p-6 flex items-center justify-between">
                        <div className="z-10 space-y-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-black group-hover:text-blue-400 transition-colors">Sony WH-1000XM5</h3>
                        ...
                        <motion.img
                            variants={{
                                hover: { scale: 1.1, rotate: -20, x: -10 }
                            }}
                    ...
                    <motion.div
                        ...
                        className="absolute inset-0 bg-blue-600/95 backdrop-blur-md flex flex-col items-center justify-center text-center p-6 z-20"
                    >
                        <h4 className="text-2xl font-black mb-2 text-white">Deal Unlocked!</h4>
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-[#1a1f2e] to-[#0f172a] border border-white/10 p-6 flex items-center justify-between">
                        <div className="z-10 space-y-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-black group-hover:text-purple-400 transition-colors">MacBook Air M2</h3>
                        ...
                        <motion.img
                            variants={{
                                hover: { scale: 1.1, rotate: 15, x: 10 }
                            }}
                            transition={{ duration: 0.4 }}
                    ...
                    <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 300, damping: 30 }}
                        className="absolute inset-0 bg-purple-600/95 backdrop-blur-md flex flex-col items-center justify-center text-center p-6 z-20"
                    >
                        <h4 className="text-2xl font-black mb-2 text-white">Student Discount</h4>
